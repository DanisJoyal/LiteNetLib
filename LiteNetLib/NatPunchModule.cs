...
namespace LiteNetLib
{
    ...
    public sealed class NatPunchModule
    {
            ...
            string additionalInfo)
        {
            ...
            var packet = _netBase.NetPacketPool.GetWithData(PacketProperty.NatIntroduction, 0,dw);
            ...
            packet = _netBase.NetPacketPool.GetWithData(PacketProperty.NatIntroduction, 0, dw);
        ...
        public void SendNatIntroduceRequest(NetEndPoint masterServerEndPoint, string additionalInfo)
        {
            ...
            //prepare packet
            var packet = _netBase.NetPacketPool.GetWithData(PacketProperty.NatIntroductionRequest, 0, dw);
        ...
        private void HandleNatIntroduction(NetDataReader dr)
        {
            ...
            writer.Put(hostByte);
            writer.Put(token);
            var packet = _netBase.NetPacketPool.GetWithData(PacketProperty.NatPunchMessage, 0, writer);
            ...
            writer.Put(hostByte);
            writer.Put(token);
            packet = _netBase.NetPacketPool.GetWithData(PacketProperty.NatPunchMessage, 0, writer);
